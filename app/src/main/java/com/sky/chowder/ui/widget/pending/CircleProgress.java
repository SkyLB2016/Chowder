        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                case R.styleable.CircleProgress_radius:
                    ...
                    break;
                case R.styleable.CircleProgress_totalColor:
                    totalColor = style.getColor(attr, totalColor);
                    break;
                case R.styleable.CircleProgress_proColor:
                    progressColor = style.getColor(attr, progressColor);
                    break;
                case R.styleable.CircleProgress_proWidth:
                ...
                case R.styleable.CircleProgress_textcolor:
                    ...
                    break;
                case R.styleable.CircleProgress_textBackground:
